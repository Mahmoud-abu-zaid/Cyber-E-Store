    ...
    <section className="grid grid-cols-1 lg:grid-cols-2 overflow-hidden">
      <div>
        <div className="bg-white flex flex-col lg:flex-row items-center gap-6  text-center lg:text-left py-1">
          <Image src="/img/PlayStation.webp" alt="PlayStation" width={300} height={400} className="hidden lg:block w-48 lg:w-72" priority />
      ...
      <div className="bg-gray-50 flex flex-col-reverse lg:flex-row items-center justify-between gap-8 lg:pl-7 px-2 lg:px-0 py-4 text-center lg:text-left">
        ...
        <Image src="/img/Macbook Air 2.webp" alt="Macbook Air" width={250} height={250} className="hidden lg:block w-60 lg:w-80" />
        <Image src="/img/Macbook Air1 .webp" alt="Macbook Air" width={250} height={250} className="block lg:hidden w-60 lg:w-80" />
      </div>
    </section>
  );
}
